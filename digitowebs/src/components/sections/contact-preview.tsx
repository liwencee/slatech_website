        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          ...
          <AnimateOnScroll animation="slide-left" className="lg:col-span-2">
            <div className="bg-secondary rounded-3xl p-8 text-white flex flex-col gap-8 h-full">
              ...
              {/* Social Media Links */}
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wider font-medium mb-3">Follow Us</p>
                <div className="flex items-center gap-3">
                  <a
                    ...
                    aria-label="WhatsApp"
                    className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-gray-300 hover:bg-green-500 hover:text-white transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label="Facebook"
                    className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-gray-300 hover:bg-blue-600 hover:text-white transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-gray-300 hover:bg-gradient-to-br hover:from-purple-500 hover:via-pink-500 hover:to-orange-400 hover:text-white transition-all duration-300"
                  >
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
