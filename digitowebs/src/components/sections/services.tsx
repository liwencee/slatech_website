...
const services = [
  {
    ...
    description:
      "Custom website designs that reflect your brand identity and engage visitors with modern, responsive layouts.",
  ...
  },
  {
    ...
    description:
      "Powerful online stores with secure payment gateways, inventory management, and conversion-optimized checkout flows.",
  ...
  },
  {
    ...
    description:
      "Data-driven SEO strategies that boost your organic rankings, drive traffic, and increase conversions.",
    href: "/services#seo",
  },
  {
    icon: (
    ...
    description:
      "Fast, reliable, and secure hosting solutions with 99.9% uptime guarantee and 24/7 technical support.",
  ...
  },
  {
    ...
    description:
      "Comprehensive website maintenance including updates, backups, security monitoring, and performance optimization.",
